...
export const data = [
  ...
  },
  {
    ...
    'Niveau 2': 'EPILEPSY',
    'Niveau 3': 'EpiCARE',
    'Niveau 4': 'Queen Elizabeth University Hospitals Campus',
    'Niveau 5': '',
    Type: 'HOSPITAL'
  },
  {
    ...
    'Niveau 2': 'EPILEPSY',
    'Niveau 3': 'EpiCARE',
    'Niveau 4': 'Oxford University Hospitals NHS Foundation Trust',
    'Niveau 5': '',
    Type: 'HOSPITAL'
  },
  {
    ...
    'Niveau 2': 'EPILEPSY',
    'Niveau 3': 'EpiCARE',
    'Niveau 4': 'University Hospital Gasthuisberg KULeuven',
    'Niveau 5': '',
    Type: 'HOSPITAL'
  },
  {
    ...
    'Niveau 2': 'EPILEPSY',
    'Niveau 3': 'EpiCARE',
    'Niveau 4': 'Motol University Hospital',
    'Niveau 5': '',
    Type: 'HOSPITAL'
  },
  {
  ...
  },
  {
    ...
    'Niveau 2': 'EPILEPSY',
    'Niveau 3': 'EpiCARE',
    'Niveau 4': 'University Hospital Bonn',
    'Niveau 5': '',
    Type: 'HOSPITAL'
  },
  {
    ...
    'Niveau 2': 'EPILEPSY',
    'Niveau 3': 'EpiCARE',
    'Niveau 4': 'University Hospital Freiburg',
    'Niveau 5': '',
    Type: 'HOSPITAL'
  },
  {
    ...
    'Niveau 3': 'EpiCARE',
    'Niveau 4':
      'IRCCS Institute of Neurological Sciences of Bologna (INSB)-AUSL di Bologna',
    'Niveau 5': '',
    Type: 'HOSPITAL'
  },
  {
    ...
    'Niveau 2': 'EPILEPSY',
    'Niveau 3': 'EpiCARE',
    'Niveau 4': 'Azienda Ospedaliero-Universitaria A. Meyer',
    'Niveau 5': '',
    Type: 'HOSPITAL'
  },
  {
    ...
    'Niveau 2': 'EPILEPSY',
    'Niveau 3': 'EpiCARE',
    'Niveau 4': 'Fondazione IRCCS Istituto Neurologico Carlo Besta',
    'Niveau 5': '',
    Type: 'HOSPITAL'
  },
  {
    ...
    'Niveau 2': 'EPILEPSY',
    'Niveau 3': 'EpiCARE',
    'Niveau 4': 'Ospedale Pediatrico Bambino Gesu',
    'Niveau 5': '',
    Type: 'HOSPITAL'
  },
  {
  ...
  },
  {
    ...
    'Niveau 2': 'EPILEPSY',
    'Niveau 3': 'EpiCARE',
    'Niveau 4': "The Children's Memorial Health Institute",
    'Niveau 5': '',
    Type: 'HOSPITAL'
  },
  {
    ...
    'Niveau 2': 'EPILEPSY',
    'Niveau 3': 'EpiCARE',
    'Niveau 4': 'Centro Hospitalar e Universitario de Coimbra',
    'Niveau 5': '',
    Type: 'HOSPITAL'
  },
  {
  ...
  },
  {
    ...
    'Niveau 3': 'EpiCARE',
    'Niveau 4':
      'Centro de Referencia de Epilepsias Refractrias Hosp de Santa Maria',
    'Niveau 5': '',
    Type: 'HOSPITAL'
  },
  {
    ...
    'Niveau 2': 'EPILEPSY',
    'Niveau 3': 'EpiCARE',
    'Niveau 4': 'Centro Hospitalar do Porto',
    'Niveau 5': '',
    Type: 'HOSPITAL'
  },
  {
    ...
    'Niveau 2': 'EPILEPSY',
    'Niveau 3': 'EpiCARE',
    'Niveau 4': 'Alexandru Obregia Clinical Hospital',
    'Niveau 5': '',
    Type: 'HOSPITAL'
  },
  {
  ...
  },
  {
    ...
    'Niveau 2': 'EPILEPSY',
    'Niveau 3': 'EpiCARE',
    'Niveau 4': 'Hospital Del Mar-Parc de Salut Mar',
    'Niveau 5': '',
    Type: 'HOSPITAL'
  },
  {
    ...
    'Niveau 2': 'EPILEPSY',
    'Niveau 3': 'EpiCARE',
    'Niveau 4': 'Hospital Universitario y Politecnico La Fe',
    'Niveau 5': '',
    Type: 'HOSPITAL'
  },
  {
  ...
  },
  {
    ...
    'Niveau 2': 'TRAUMATIC BRAIN INJURIES',
    'Niveau 3': 'CENTER TBI',
    'Niveau 4': 'University of Cambridge',
    'Niveau 5': '',
    Type: 'UNI'
  },
  {
    ...
    'Niveau 2': 'TRAUMATIC BRAIN INJURIES',
    'Niveau 3': 'CENTER TBI',
    'Niveau 4': 'Karolinska Institutet',
    'Niveau 5': '',
    Type: 'UNI'
  },
  {
  ...
  },
  {
    ...
    'Niveau 2': 'TRAUMATIC BRAIN INJURIES',
    'Niveau 3': 'CENTER TBI',
    'Niveau 4': 'Trnava University in Trnava',
    'Niveau 5': '',
    Type: 'HOSPITAL'
  },
  {
  ...
  },
  {
    ...
    'Niveau 2': 'TRAUMATIC BRAIN INJURIES',
    'Niveau 3': 'CENTER TBI',
    'Niveau 4': 'Turku University Central Hospital',
    'Niveau 5': '',
    Type: 'HOSPITAL'
  },
  {
    ...
    'Niveau 2': 'TRAUMATIC BRAIN INJURIES',
    'Niveau 3': 'CENTER TBI',
    'Niveau 4': 'Antwerp University Hospital',
    'Niveau 5': '',
    Type: 'HOSPITAL'
  },
  {
  ...
  },
  {
    ...
    'Niveau 2': 'TRAUMATIC BRAIN INJURIES',
    'Niveau 3': 'CENTER TBI',
    'Niveau 4': 'Azienda Ospedaliera San Gerardo di Monza',
    'Niveau 5': '',
    Type: 'HOSPITAL'
  },
  {
    ...
    'Niveau 2': 'TRAUMATIC BRAIN INJURIES',
    'Niveau 3': 'CENTER TBI',
    'Niveau 4': 'MRC Biostatistics Unit',
    'Niveau 5': '',
    Type: 'HOSPITAL'
  },
  {
  ...
  },
  {
    ...
    'Niveau 2': 'TRAUMATIC BRAIN INJURIES',
    'Niveau 3': 'CENTER TBI',
    'Niveau 4': 'Leids Universitair Medisch Centrum',
    'Niveau 5': '',
    Type: 'HOSPITAL'
  },
  {
  ...
  },
  {
    ...
    'Niveau 2': 'TRAUMATIC BRAIN INJURIES',
    'Niveau 3': 'CENTER TBI',
    'Niveau 4': 'Finnish Institute for molecular Medicine',
    'Niveau 5': '',
    Type: 'UNI'
  },
  {
  ...
  },
  {
    ...
    'Niveau 2': 'TRAUMATIC BRAIN INJURIES',
    'Niveau 3': 'CREACTIVE',
    'Niveau 4': 'Magyar Honvedseg\nEgeszsegugyi Kozpont',
    'Niveau 5': '...',
    Type: 'HOSPITAL'
  },
  {
  ...
  },
  {
    ...
    'Niveau 2': 'TRAUMATIC BRAIN INJURIES',
    'Niveau 3': 'CREACTIVE',
    'Niveau 4': 'Warszawski Uniwersytet\nMedyczny',
    'Niveau 5': '...',
    Type: 'HOSPITAL'
  },
  {
  ...
  },
  {
    ...
    'Niveau 2': 'TRAUMATIC BRAIN INJURIES',
    'Niveau 3': 'CREACTIVE',
    'Niveau 4': 'Splosna Bolnisnica Novo\nMesto',
    'Niveau 5': '...',
    Type: 'HOSPITAL'
  },
  {
  ...
  },
  {
    ...
    'Niveau 2': 'TRAUMATIC BRAIN INJURIES',
    'Niveau 3': 'CREACTIVE',
    'Niveau 4': 'Univerzitetni Klinicni\nCenter Ljubljana',
    'Niveau 5': '...',
    Type: 'HOSPITAL'
  },
  {
  ...
  },
  {
    ...
    'Niveau 2': 'TRAUMATIC BRAIN INJURIES',
    'Niveau 3': 'CREACTIVE',
    'Niveau 4': 'Soroka University Medical Centre',
    'Niveau 5': '...',
    Type: 'HOSPITAL'
  },
  {
  ...
  },
  {
    ...
    'Niveau 2': 'DEMENTIA',
    'Niveau 3': 'ERN - RND',
    'Niveau 4': 'University Hospitals Leuven',
    'Niveau 5': '',
    Type: 'HOSPITAL'
  },
  {
  ...
  },
  {
    ...
    'Niveau 2': 'DEMENTIA',
    'Niveau 3': 'ERN - RND',
    'Niveau 4': 'Semmelweis University',
    'Niveau 5': '',
    Type: 'HOSPITAL'
  },
  {
  ...
  },
  {
    ...
    'Niveau 2': 'DEMENTIA',
    'Niveau 3': 'ERN - RND',
    'Niveau 4': 'University Medical Centre Ljubljana',
    'Niveau 5': '',
    Type: 'HOSPITAL'
  },
  {
    ...
    'Niveau 2': 'DEMENTIA',
    'Niveau 3': 'ERN - RND',
    'Niveau 4': 'University College London Hospitals NHS Foundation Trust',
    'Niveau 5': '',
    Type: 'HOSPITAL'
  },
  {
  ...
  },
  {
    'Niveau 1': 'SP8',
    'Niveau 2': 'MIP DATA GOVERNANCE STEERING COMMITTEE',
    'Niveau 3': 'HBP DATA GOVERNANCE WORKING GROUP',
    'Niveau 4': '',
    'Niveau 5': '',
    Type: 'HBP'
  },
  {
    'Niveau 1': 'SP8',
    'Niveau 2': 'MIP DATA GOVERNANCE STEERING COMMITTEE',
    'Niveau 3': 'HBP DATA PROTECTION OFFICER',
    'Niveau 4': '',
    'Niveau 5': '',
    Type: 'HBP'
  },
  ...
  },
  {
    ...
    'Niveau 3': 'EFNA',
    'Niveau 4':
      'Patients and Consumer Working Party at the European Medicines Agency [PCWP]',
    'Niveau 5': '',
    Type: 'EXT'
  },
  {
    ...
    'Niveau 3': 'EFNA',
    'Niveau 4':
      'Think-Tank at the European Federation for Pharmaceutical Industry Associations',
    'Niveau 5': '',
    Type: 'EXT'
  },
  {
    ...
    'Niveau 3': 'EFNA',
    'Niveau 4':
      'European Society of Radiology – Patient Advisory Group [ESR-PAG]',
    'Niveau 5': '',
    Type: 'EXT'
  },
  {
  ...
  },
  {
    'Niveau 1': 'SP8',
    'Niveau 2': 'MIP DATA GOVERNANCE STEERING COMMITTEE',
    'Niveau 3': 'HBP ETHICS ADVISORY BOARD',
    'Niveau 4': '',
    'Niveau 5': '',
    Type: 'HBP'
  },
  ...
  },
  {
    ...
    'Niveau 2': 'OTHER INTERACTIONS',
    'Niveau 3': 'SP5',
    'Niveau 4': 'HIGH LEVEL SUPPORT TEAM',
    'Niveau 5': '',
    Type: 'HBP'
  },
  {
    ...
    'Niveau 2': 'OTHER INTERACTIONS',
    'Niveau 3': 'SP12',
    'Niveau 4': 'ETHICS - PRIVACY - PROTECTION',
    'Niveau 5': '',
    Type: 'HBP'
  },
  {
    ...
    'Niveau 2': 'OTHER INTERACTIONS',
    'Niveau 3': 'SP12',
    'Niveau 4': "PUBLIC AND PATIENT'S OUTREACH",
    'Niveau 5': '',
    Type: 'HBP'
  },
  {
